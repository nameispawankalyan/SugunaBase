...
import { FileCode, Loader2, Play, ExternalLink, Terminal, Plus } from 'lucide-react';
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                ...
                                <div className="space-y-1 mb-6">
                                    <h3 className="text-2xl font-black text-gray-900 group-hover:text-purple-600 transition-colors uppercase tracking-tight">{fn.name}</h3>
